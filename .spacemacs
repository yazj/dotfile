...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Hack Nerd Font" ;;"Source Code Pro"
                               :size 13.0
                               :weight normal
                               :width normal)
...
before packages are loaded."
  ...
  ;; Set evil escape key map
  ;; At Insert mode ,use jj to escape quickly
